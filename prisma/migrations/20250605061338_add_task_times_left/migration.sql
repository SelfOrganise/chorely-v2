...
INSERT INTO "new_Task" ("archived", "description", "flagged", "icon", "id", "lastCompleted", "requiresComment", "score", "title") SELECT "archived", "description", "flagged", "icon", "id", "lastCompleted", "requiresComment", "score", "title" FROM "Task";
DROP TABLE "Task";
